...
\end{split}
\end{equation}
and further substituting Eqs. (\ref{epsilon2}), (\ref{kappa2}) into above equation gives the final discrete equilibrium equations: 
\begin{equation}
