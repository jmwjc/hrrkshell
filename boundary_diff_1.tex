...
\end{equation}
where 
\DIFadd{the components of stiffness matrices and force vectors in discrete equilibrium equations can be evaluated as follows:}
...
% \DIFdel{\sum_{J=1}^{n_p}(\boldsymbol K_{IJ} + \boldsymbol K^c_{IJ} + \boldsymbol K^s_{IJ}) \boldsymbol d_J = \boldsymbol f_I + \boldsymbol f^c + \boldsymbol f^s
% }\end{displaymath}%DIFAUXCMD
% \DIFdelend \DIFaddbegin \begin{equation}
% \DIFadd{(\boldsymbol K + \boldsymbol K^c + \boldsymbol K^s) \boldsymbol d = \boldsymbol f + \boldsymbol f^c + \boldsymbol f^s
...
% \begin{split}
% \DIFdel{\boldsymbol K^c_{IJ} = }&\DIFdel{- \int_{\Gamma_v} (\Psi_I \boldsymbol T_{NJ} + \boldsymbol T_{NJ} \Psi_J) d\Gamma }\\
%                                      &\DIFdel{+ \int_{\Gamma_\theta} (\Psi_{I,\gamma} n^\gamma \boldsymbol a_3 \boldsymbol M_{\boldsymbol{nn}J} + \boldsymbol a_3 \boldsymbol M_{\boldsymbol{nn}I} \Psi_{I,\gamma}n^\gamma)d\Gamma }\\
%                                      & \DIFdel{+ (}[[\DIFdel{\Psi_I \boldsymbol a_3 \boldsymbol P_J}]] \DIFdel{+ }[[\DIFdel{\boldsymbol P_I \boldsymbol a_3 \Psi_J}]]\DIFdel{)_{\boldsymbol x \in C_v}
% }\end{split} \\
% \DIFdel{\boldsymbol f^c_I = }&\DIFdel{- \int_{\Gamma_v} \boldsymbol T_I \cdot \bar{\boldsymbol v} d\Gamma + \int_{\Gamma_\theta} \boldsymbol M_{\boldsymbol{nn}I} \bar{\theta}_{\boldsymbol n} d\Gamma + }[[\DIFdel{\boldsymbol P_I\boldsymbol a_3 \cdot \bar{\boldsymbol v}}]]\DIFdel{_{\boldsymbol x \in C_v}
% }\end{align*}%DIFAUXCMD
% \DIFdelend \DIFaddbegin \begin{align}
% \begin{split}
% \DIFadd{\boldsymbol K^c_{IJ} = }&\DIFadd{- \int_{\Gamma_v} (\Psi_I \boldsymbol T_{NJ} + \boldsymbol T_{NI} \Psi_J) d\Gamma }\\
%                                      &\DIFadd{+ \int_{\Gamma_\theta} (\Psi_{I,\gamma} n^\gamma \boldsymbol a_3 \boldsymbol M_{\boldsymbol{nn}J} + \boldsymbol a_3 \boldsymbol M_{\boldsymbol{nn}I} \Psi_{J,\gamma}n^\gamma)d\Gamma }\\
%                                      & \DIFadd{+ (}[[\DIFadd{\Psi_I \boldsymbol a_3 \boldsymbol P_J}]] \DIFadd{+ }[[\DIFadd{\boldsymbol P_I \boldsymbol a_3 \Psi_J}]]\DIFadd{)_{\boldsymbol x \in C_v}
% }\end{split} \\
% \DIFadd{\boldsymbol f^c_I = }&\DIFadd{- \int_{\Gamma_v} \boldsymbol T_I \cdot \bar{\boldsymbol v} d\Gamma + \int_{\Gamma_\theta} \boldsymbol M_{\boldsymbol{nn}I} \bar{\theta}_{\boldsymbol n} d\Gamma + }[[\DIFadd{\boldsymbol P_I\boldsymbol a_3 \cdot \bar{\boldsymbol v}}]]\DIFadd{_{\boldsymbol x \in C_v}
% }\end{align}\DIFaddend 
\begin{align}
\begin{split}
...
\begin{align}
    \boldsymbol K^s_{IJ} &= \DIFdel{\alpha_v} \DIFadd{\boldsymbol \alpha_v} \int_{\Gamma_v} \Psi_I \Psi_J \DIFdelbegin %DIFDELCMD < \boldsymbol %%%
