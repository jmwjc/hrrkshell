...
\end{split}
\end{equation}
where $\bar{\boldsymbol T}$, $\bar M_{\boldsymbol nn}$ and $\bar P$ are the prescribed traction, bending moment and concentrated force on the edges $\Gamma_T$, $\Gamma_M$ and corner $C_P$, respectively. All the specified boundaries meet the following geometric relationships:
